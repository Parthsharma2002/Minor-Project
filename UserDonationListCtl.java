...
/**
 * Servlet implementation class UserDonationListCtl
 */
 ...
 *
 */
@WebServlet(name = "UserDonationListCtl", urlPatterns = { "/ctl/donations" })
public class UserDonationListCtl extends BaseCtl {
	private static Logger log = Logger.getLogger(UserDonationListCtl.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("USER_DONATION_LIST_CTL doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				ServletUtility.redirect(OMDSView.USER_DONATION_LIST_CTL, request, response);
				return;
		...
		log.debug("USER_DONATION_LIST_CTL doGet End");
	...
	protected String getView() {
		return OMDSView.USER_DONATION_LIST_VIEW;
	}
}
