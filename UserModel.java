...
public void accept(UserBean bean) throws ApplicationException {
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE USER SET FIRSTNAME=?,LASTNAME=?,LOGINID=?,PASSWORD=?,ROLEID=?,ROLENAME=?,MOBILENO=?,"
					+ "GENDER=?,UNIQUEPROOF=?,"
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM USER WHERE roleid <> 3 and 1=1");
		if (bean != null) {
			if (bean.getId() > 0) {
	 ...
	 */
		...
		public boolean changePassword(Long id, String oldPassword, String newPassword)
			...
			System.out.println("pass = "+beanExist.getPassword());
