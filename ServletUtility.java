...
import in.co.omd.controller.BaseCtl;
import in.co.omd.controller.OMDSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OMDSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
